...
some issues). The current Agensgraph source is based on PostgreSQL 13.

## Building

```shell
git clone https://github.com/turicas/agensgraph-docker.git
docker build -t turicas/agensgraph:2.13.1 agensgraph-docker/13/bullseye
```
